...
VALUES
    (10001, 'Pablo Picasso', '+34 636 17 63 82', 'xexample@example.com', 'Paseo de la Chopera, 14', 'Madrid', 'Madrid', 'Spain', '28045'),
    (20001, 'Abraham Lincoln', '+1 305 907 7086', 'example@example.com', '120 SW 8th St', 'Miami', 'Florida', 'United States', '33130'),
    (30001, 'Napoléon Bonaparte', '+33 1 79 75 40 00', 'example@example.com', '40 Rue du Colisée', 'Paris', 'Île-de-France', 'France', '75008');
